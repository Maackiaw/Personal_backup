...
#include "log.h"
#define i2c_write(slave_addr, reg_addr, length, data) (HAL_OK == HAL_I2C_Mem_Write(&hi2c1, slave_addr, reg_addr, I2C_MEMADD_SIZE_8BIT, data, length, 300))?0:1
#define i2c_read(slave_addr, reg_addr, length, data)	(HAL_OK == HAL_I2C_Mem_Read(&hi2c1, slave_addr, reg_addr, I2C_MEMADD_SIZE_8BIT, data, length, 300))?0:1
